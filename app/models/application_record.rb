class ApplicationRecord < ActiveRecord::Base
	...
	def class_methods_before
		...
		def self.instance_methods_before
		...
		def self.instance_methods_after_migration
			# no ar relations yet
			# ran db:dcms
			# added artists_controller
			# total methods now:  389 (18 new methods!)
			[:!, 
			:!=, 
			:!~, 
			:<=>, 
		...
		def new_methods_after_migration
			[:name, 
			:name=, 
			:name?, 
			:name_before_last_save, 
